...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#1E1E1E] text-white border-t border-white/10 pt-12 pb-8">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-10">
                    {/* Brand Column - spans 2 on small so it has room */}
                    ...
                    {/* Services Column */}
                    <div>
                        <h4 className="text-white font-medium mb-4 tracking-wide text-sm">Services</h4>
                    ...
                    {/* Contact Column */}
                    <div className="col-span-2 lg:col-span-1">
                        <h4 className="text-white font-medium mb-4 tracking-wide text-sm">Contact</h4>
