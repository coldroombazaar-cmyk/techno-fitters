                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button
                            ...
                            className="px-8 py-4 bg-white text-brand-green font-bold tracking-wide rounded hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-white/20 uppercase"
                        >
                            START A PROJECT
                        </button>
                        <Link
